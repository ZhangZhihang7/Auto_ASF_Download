...
dataTable = readtable('./csvfloder_single/TurkeyM5.6/search_results.csv', 'Delimiter', ',');
save('dataTable.mat', 'dataTable');

% Given input time
originTime = '2024-04-18T15:11:25.470Z';                                   % Please type the earthquake time by yyyy-mm-ddThh-MM-ss-SSSZ
...
% Make a new filelist to keep the url
fileID = fopen('filelist', 'w');
